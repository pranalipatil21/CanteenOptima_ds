...
import { Truck, ChefHat, Box, Users, Utensils, Coins, ListOrdered, Search, Activity } from 'lucide-react';
    ...
    <div className="sidebar">
      ...
      <nav style={{ padding: '1rem 0', flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ padding: '1rem 1.5rem', marginTop: '1rem' }}>
          <h2 className="text-xs text-muted" style={{ textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem', fontWeight: 600 }}>Overview</h2>
          <NavLink
            to="/analysis"
            style={({ isActive }) => ({
              display: 'flex',
